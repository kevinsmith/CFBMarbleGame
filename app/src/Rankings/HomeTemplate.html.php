    ...
    <div class="mx-auto max-w-3xl">
        <main class="py-10">
            ...
            <div class="prose mt-12">
                <ol>
                    <li>
                        <p>Every FBS school starts off with 100 marbles, plus 10 bonus marbles for every game on their schedule against a power conference opponent or <a href="https://x.com/iowahawkblog/status/1985836819116925090" rel="nofollow">Notre Dame</a></p>
                    </li>
                    <li>
